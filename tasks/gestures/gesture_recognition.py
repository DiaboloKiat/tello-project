...
class GestureRecognition:
    ...
    def load_model(self):
        ...
        # Read labels ###########################################################
        with open('/home/diabolokiat/tello-project/tasks/model/keypoint_classifier/keypoint_classifier_label.csv',
    ...
    def _logging_csv(self, number, mode, landmark_list):
        ...
        if mode == 1 and (0 <= number <= 9):
            print("WRITE")
            csv_path = '/home/diabolokiat/tello-project/tasks/model/keypoint_classifier/keypoint1.csv'
